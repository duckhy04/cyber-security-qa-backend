...
import org.example.cybersecurityqabackend.exception.CustomUsernameAlreadyExistsException;
...
public class AuthServiceImpl implements AuthService {
    ...
    public RegisterResponse register(RegisterRequest registerDto) {
        ...
        if (user.isPresent()) {
            throw new CustomUsernameAlreadyExistsException("Username or email already exists");
        }
